...
public class DACMatrixMultiplyHalfMultiply
	implements Experiment<InputMatrices, DACMatrixMultiplyHalfMultiply> {
	Matrix output;
	InputMatrices inputs;

	DACMatrixMultiplyHalfMultiply(){}

	public static DACMatrixMultiplyHalfMultiply emptyObject(){return new DACMatrixMultiplyHalfMultiply();}
	...
	public Matrix dacMultiply(InputMatrices input){
		...
		if(input.size == 1){	
			HalfNaiveMultiply mult = HalfNaiveMultiply.emptyObject();
	...
	public Score[] scores(DACMatrixMultiplyHalfMultiply correctObject){
	...
	public static void main(String[] args){
		...
		DACMatrixMultiplyHalfMultiply mult = new DACMatrixMultiplyHalfMultiply();
